 ...
 * (good!) policy in place that once an identifier has been deobfuscated, it cannot be renamed,
 * because that would break the build for every mod that references that identifier.
 *
...
public class PacketInfo {
	...
	static {
		...
		add(0x02, "handshake   ", "Handshake", Packet2Handshake.class);
		...
		// (unassigned ids)
		add(0x32, "prechunk    ", "Map Column Allocation", Packet50PreChunk.class);
		...
		// (unassigned ids)
		add(0x46, "ch game st  ", "Change Game State", Packet70Bed.class);
